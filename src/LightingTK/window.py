...
class ImageDialog(QDialog):
    def __init__(self):
        ...
        self.ui.pushButton_Character_RL.clicked.connect(RenderLayer.RenderLayerCharacter)
        self.ui.pushButton_CrowdsOneRL.clicked.connect(RenderLayer.Characters)
        self.ui.pushButton_CrowdsTwoRL.clicked.connect(RenderLayer.Crowds)
